...
public class ReservasDAO {
    ...
    public boolean numeroReservaExiste(int numeroReserva) {
        String sql = "SELECT COUNT(*) FROM reservas WHERE ID_RES = ?";
        ...
        try (PreparedStatement pStm = con.prepareStatement(sql)) {
            ...
            System.out.println("Erro ao verificar se o número de reserva existe.");
            throw new RuntimeException(ex);
        }
